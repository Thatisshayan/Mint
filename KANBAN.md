...
| 3 | Add backend + frontend test scaffolding | TODO | Add `vitest` for frontend and backend test runner; wire into CI |
...
| 6 | Enable error monitoring / health checks | TODO | Add `/health` and structured error handling across routes |
