...
export default async function templateRoutes(fastify: any) {
  fastify.get('/templates', { preHandler: authMiddleware }, async (request: any) => {
  ...
  fastify.post('/templates', { preHandler: authMiddleware }, async (request: any) => {
  ...
  fastify.get('/templates/:id', { preHandler: authMiddleware }, async (request: any) => {
  ...
  fastify.delete('/templates/:id', { preHandler: authMiddleware }, async (request: any, reply: any) => {
    const { id } = request.params as { id: string };
